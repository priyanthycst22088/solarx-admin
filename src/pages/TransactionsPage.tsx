...
import { ShoppingCart, Search, Filter, Eye, AlertTriangle, CheckCircle } from 'lucide-react';
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        {transaction.status === 'disputed' && (
                          <Button size="sm" variant="default" className="bg-warning hover:bg-warning/90 text-warning-foreground">
                            Resolve
                          </Button>
                        )}
